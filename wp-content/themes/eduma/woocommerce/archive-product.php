...
<?php if ( have_posts() ) : ?>
	...
	?>
	<?php if ( ! isset( $theme_options_data['thim_woo_cate_display_layout'] ) || $theme_options_data['thim_woo_cate_display_layout'] != 'grid' ) {
	...
	<?php if ( isset( $theme_options_data['thim_woo_cate_display_layout'] ) && $theme_options_data['thim_woo_cate_display_layout'] == 'grid' ) {
		do_action( 'woocommerce_before_shop_loop' );
		echo '<div id="thim-product-archive" class="thim-product-list">';
