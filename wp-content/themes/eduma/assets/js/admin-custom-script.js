jQuery(function ($) {
	...
	function thim_eduma_install_demo() {
		...
		$('.theme[aria-describedby*=demo-university-3], .theme[aria-describedby*=demo-university-4]').hide();
		$(document).on('change', '#thim-select-page-builder', function () {
			...
			if( elem_val == 'visual_composer') {
				...
				$('.theme[aria-describedby*=demo-university-3], .theme[aria-describedby*=demo-university-4]').show();
			}
