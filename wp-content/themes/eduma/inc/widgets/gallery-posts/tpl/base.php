...
if ( $posts_display->have_posts() ) :
	...
	while ( $posts_display->have_posts() ) : $posts_display->the_post();
		...
		$img   = thim_get_feature_image( get_post_thumbnail_id(), 'full', apply_filters( 'thim_gallery_post_thumbnail_width', 450 ), apply_filters( 'thim_gallery_post_thumbnail_height', 450 ), get_the_title() );
		$class = '';
